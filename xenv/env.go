...
func (env *Environment) Caller() ablock.Address                    { return ablock.Address(env.contract.Caller()) }
func (env *Environment) To() ablock.Address                        { return ablock.Address(env.contract.Address()) }
...
func (env *Environment) Log(abi *abi.Event, address ablock.Address, topics []ablock.Bytes32, args ...interface{}) {
