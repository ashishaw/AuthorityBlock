...
type casts map[ablock.Bytes32]uint32
...
func (ca casts) Slice(finalized ablock.Bytes32) []struct {
	checkpoint ablock.Bytes32
	quality    uint32
} {
	list := make([]struct {
		checkpoint ablock.Bytes32
...
func (ca casts) Mark(checkpoint ablock.Bytes32, quality uint32) {
