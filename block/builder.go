...
func (b *Builder) ParentID(id ablock.Bytes32) *Builder {
...
func (b *Builder) Beneficiary(addr ablock.Address) *Builder {
	b.headerBody.Beneficiary = addr
	return b
}

// StateRoot set state root.
func (b *Builder) StateRoot(hash ablock.Bytes32) *Builder {
	b.headerBody.StateRoot = hash
	return b
}

// ReceiptsRoot set receipts root.
func (b *Builder) ReceiptsRoot(hash ablock.Bytes32) *Builder {
