...
func TestHeader_BetterThan(t *testing.T) {
	...
	largerID.cache.id.Store(ablock.Bytes32{1})
	smallerID.cache.id.Store(ablock.Bytes32{0})
	...
	tests := []struct {
		...
		},
		{
			...
			test: func(t *testing.T) {
				...
				assert.Equal(t, ablock.Bytes32{}.Bytes(), dst.Extension.Alpha)
