...
type headerBody struct {
	...
	StateRoot       ablock.Bytes32
	ReceiptsRoot    ablock.Bytes32
...
func (h *Header) ParentID() ablock.Bytes32 {
...
func (h *Header) ID() (id ablock.Bytes32) {
	...
	return ablock.Blake2b(h.SigningHash().Bytes(), signer[:])
}

// SigningHash computes hash of all header fields excluding signature.
func (h *Header) SigningHash() (hash ablock.Bytes32) {
...
func (h *Header) Signer() (ablock.Address, error) {
	if h.Number() == 0 {
		// special case for genesis block
		return ablock.Address{}, nil
	}
	...
	return ablock.Address(crypto.PubkeyToAddress(*pub)), nil
}
...
func Number(blockID ablock.Bytes32) uint32 {
