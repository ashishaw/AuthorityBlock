...
var (
	...
	emptyRoot = ablock.Blake2b(rlp.EmptyString)
	// This is the known hash of an empty state trie entry.
	emptyState = ablock.Blake2b(nil)
)
...
func New(root ablock.Bytes32, db Database) (*Trie, error) {
	trie := &Trie{db: db}
...
func (t *Trie) Hash() ablock.Bytes32 {
...
func (t *Trie) Commit() (root ablock.Bytes32, err error) {
	if t.db == nil {
...
func (t *Trie) CommitTo(db DatabaseWriter) (root ablock.Bytes32, err error) {
