...
import "github.com/ashishaw/authorityblock/ablock"
...
func (n Node) Hash() (hash ablock.Bytes32) {
	if n.node != nil {
...
func NewExtended(root ablock.Bytes32, seq uint64, db Database, nonCrypto bool) *ExtendedTrie {
	ext := &ExtendedTrie{trie: Trie{db: db}, nonCrypto: nonCrypto}
	if (root != ablock.Bytes32{}) && root != emptyRoot {
		if db == nil {
...
func (e *ExtendedTrie) Hash() ablock.Bytes32 {
	t := &e.trie
	return t.Hash()
}
...
func (e *ExtendedTrie) Commit(seq uint64) (root ablock.Bytes32, err error) {
	t := &e.trie
	if t.db == nil {
...
func (e *ExtendedTrie) CommitTo(db DatabaseWriter, seq uint64) (root ablock.Bytes32, err error) {
	t := &e.trie
