...
type Event struct {
	...
	BlockTime   uint64
	TxID        ablock.Bytes32
	TxOrigin    ablock.Address //contract caller
	ClauseIndex uint32
	Address     ablock.Address // always a contract address
	Topics      [5]*ablock.Bytes32
	Data        []byte
}
...
type TransferCriteria struct {
	...
	Recipient *ablock.Address //who recieved tokens
}
