...
import (
	...
	"github.com/ashishaw/authorityblock/comm/proto"
	"github.com/ashishaw/authorityblock/ablock"
)

type announcement struct {
	newBlockID ablock.Bytes32
	peer       *Peer
}
...
func (c *Communicator) announcementLoop() {
	...
	fetchingBlockIDs := map[ablock.Bytes32]int{}
...
func (c *Communicator) fetchBlockByID(peer *Peer, newBlockID ablock.Bytes32) {
