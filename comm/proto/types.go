...
func NotifyNewBlockID(ctx context.Context, rpc RPC, id ablock.Bytes32) error {
...
func GetBlockByID(ctx context.Context, rpc RPC, id ablock.Bytes32) (rlp.RawValue, error) {
...
func GetBlockIDByNumber(ctx context.Context, rpc RPC, num uint32) (ablock.Bytes32, error) {
	var id ablock.Bytes32
