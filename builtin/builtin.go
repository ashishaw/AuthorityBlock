...
import (
	...
	"github.com/ashishaw/authorityblock/builtin/energy"
	"github.com/ashishaw/authorityblock/builtin/gen"
	"github.com/ashishaw/authorityblock/builtin/params"
	"github.com/ashishaw/authorityblock/builtin/prototype"
...
func FindNativeCall(to ablock.Address, input []byte) (*abi.Method, func(*xenv.Environment) []interface{}, bool) {
