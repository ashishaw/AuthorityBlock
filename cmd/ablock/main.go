...
import (
	...
	"github.com/ashishaw/authorityblock/api"
	"github.com/ashishaw/authorityblock/bft"
	"github.com/ashishaw/authorityblock/cmd/ablock/node"
	"github.com/ashishaw/authorityblock/cmd/ablock/optimizer"
	"github.com/ashishaw/authorityblock/cmd/ablock/solo"
	...
	_ "github.com/ashishaw/authorityblock/tracers/native"
)
...
func main() {
	app := cli.App{
		Version:   fullVersion(),
		Name:      "ABlock",
		Usage:     "Node of Authority Block Network",
		Copyright: "2022 Ashish Waingankar <http://github.com/ashishaw/>",
		Flags: []cli.Flag{
			networkFlag,
			configDirFlag,
			dataDirFlag,
...
func masterKeyAction(ctx *cli.Context) error {
	...
	if !hasImportFlag && !hasExportFlag {
		...
		fmt.Println("Master:", ablock.Address(crypto.PubkeyToAddress(masterKey.PublicKey)))
		return nil
	}
	...
	if hasImportFlag {
		...
		fmt.Println("Master key imported:", ablock.Address(key.Address))
		return nil
	}
